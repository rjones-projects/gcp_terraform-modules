...
This module sets `lifecycle.prevent_destroy = true` on keyrings and keys to
prevent accidental destruction. If you need to allow destroys (e.g. for test
cycles), remove or override the lifecycle blocks in `main.tf`.
...
| [kms](variables.tf#L33) | KMS module config with spec. | <code>any</code> |  | <code>null</code> |
| [region](variables.tf#L157) | Default region used when keyring location is not provided. | <code>string</code> |  | <code>null</code> |
